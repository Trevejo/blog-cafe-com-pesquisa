...
import dilemaImage from '../../assets/dilema-do-prisioneiro.png';
import matrizImage from '../../assets/matriz-de-payoff.png';
import cadeiaImage from '../../assets/cadeia-de-suprimentos.jpg';
...
<div style="text-align: center;">
  <Image 
    src={theoryImage}
    alt="Capa do livro Theory of Games and Economic Behavior" 
    width={300}
    height={400}
  />
