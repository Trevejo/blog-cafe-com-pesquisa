...
import simulacaoImage from '../../assets/simulacao-de-filas.png';
import fluxoImage from '../../assets/fluxo-de-atendimento.png';
import diagramaImage from '../../assets/diagrama-m-m-1.png';
